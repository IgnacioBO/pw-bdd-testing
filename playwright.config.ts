...
export default defineConfig({
  ...
  reporter: process.env.CI ? (isShardRun ? [['blob', {outputDir: 'reports/blob-report/'}]] : [
   ['html', {outputFolder: 'reports/playwright-report/', externalAttachments: true, skipAttachments: ['text/x.cucumber.log+plain'] }],
    cucumberReporter('html', { outputFile: 'reports/cucumber-report/index.html', externalAttachments: true, skipAttachments: ['text/x.cucumber.log+plain'] }),
    cucumberReporter('json', { outputFile: 'reports/cucumber-report/report.json', skipAttachments: ['text/x.cucumber.log+plain'] }),
    cucumberReporter('message', { outputFile: 'reports/cucumber-report/messages.ndjson', skipAttachments: ['text/x.cucumber.log+plain'] })  
  ]) : [
